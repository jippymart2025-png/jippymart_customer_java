...
class AddressListController extends GetxController {
  ...
  RxString localityText = "".obs; // Reactive string for locality display
  ...
  clearData() {
    ...
    localityText.value = ""; // Clear reactive string
  ...
  setData(ShippingAddress shippingAddress) {
    ...
    localityText.value = shippingAddress.locality.toString(); // Set reactive string
