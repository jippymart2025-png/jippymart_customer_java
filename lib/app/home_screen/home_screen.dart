...
import 'package:jippymart_customer/app/home_screen/category_restaurant_screen.dart';
import 'package:jippymart_customer/app/home_screen/discount_restaurant_list_screen.dart';
import 'package:jippymart_customer/app/home_screen/restaurant_list_screen.dart';
import 'package:jippymart_customer/app/home_screen/story_view.dart';
import 'package:jippymart_customer/app/home_screen/view_all_category_screen.dart';
import 'package:jippymart_customer/app/location_permission_screen/location_permission_screen.dart';
import 'package:jippymart_customer/app/restaurant_details_screen/restaurant_details_screen.dart';
import 'package:jippymart_customer/app/scan_qrcode_screen/scan_qr_code_screen.dart';
...
import 'package:jippymart_customer/controllers/home_controller.dart';
import 'package:jippymart_customer/controllers/map_view_controller.dart';
...
// import 'package:geolocator/geolocator.dart'; // Removed - using LocationService instead
...
class HomeScreen extends StatelessWidget {
  ...
  static Future<void> _checkMartAvailability() async {
    try {
      ...
      if (martVendors.isEmpty) {
        ...
        if (isMartTemporarilyClosed) {
          ...
          ComingSoonDialogHelper.show(
            ...
            message: "Mart Available from 7AM to 9PM",
          );
      ...
      print('📱 [HOME_SCREEN] Showing COMING SOON dialog due to error');
                                                            ...
                                                            .checkPermission(
                                                                onTap:
                                                                  ...
                                                                  ShippingAddress
                                                                      ...
                                                                      ShippingAddress();
                                                                  try {
                                                                    // Location permission and current position handled by LocationService
                                                                    ShowToastDialog
                                                                        .closeLoader();
                                                                    if (Constant
                                                                            .selectedMapType ==
                                      ...
                                      child: SingleChildScrollView(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            //     sectionTitle: 'Spotlight Selections',
                                            //     spotlightItems: [
                                            //       {
                                            //         'title': 'Fresh fruits',
                    ...
                    children: [
                      ...
                      Transform.translate(
                        ...
                        child: Row(
                          ...
                          children: [
                            Visibility(
                              visible: (vendorModel.isSelfDelivery == true &&
            ...
            Constant.selectedMapType == "osm"
                ...
                : GoogleMap(
                    ...
                    initialCameraPosition: CameraPosition(
                      zoom: 18,
                      target: controller
                              .homeController.allNearestRestaurant.isEmpty
                          ? LatLng(
                          ...
                          : LatLng(
                              controller.homeController.allNearestRestaurant
                                      .first.latitude ??
                                  45.521563,
                              controller.homeController.allNearestRestaurant
                                      .first.longitude ??
