...
class FavouriteScreen extends StatelessWidget {
              ...
              body: Container(
                ...
                child: controller.isLoading.value
                    ? const AppLoadingWidget(
                        ...
                        subtitle: "Getting your favorite restaurants & dishes...",
                    ...
                    : Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            //   return Text(
                            //     "${Constant.userModel?.active.toString()}",
                            //   );
                            // }),
                            Expanded(
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: controller
                                                ...
                                                ? controller.favouriteVendorList
                                                        .isEmpty
                                                              ...
                                                              if (snapshot
                                                                ...
                                                                if (snapshot
                                                                  ...
                                                                  return InkWell(
                                                                    onTap:
                                                                        () async {
                                                                      await FireStoreUtils.getVendorById(productModel
                                                                              .vendorID
                                                                              .toString())
                                                                          .then(
                                                                        (value) {
  ...
  Future<Map<String, dynamic>> getPrice(ProductModel productModel) async {
    ...
    if (productModel.itemAttribute != null) {
      ...
      price = Constant.productCommissionPrice(
          vendorModel!, productModel.price.toString());
      disPrice = Constant.productCommissionPrice(
          vendorModel, productModel.disPrice.toString());
    }
...
// import 'package:jippymart_customer/constant/constant.dart';
// import 'package:jippymart_customer/constant/show_toast_dialog.dart';
// import 'package:jippymart_customer/controllers/favourite_controller.dart';
// import 'package:jippymart_customer/models/favourite_item_model.dart';
// import 'package:jippymart_customer/models/favourite_model.dart';
// import 'package:jippymart_customer/models/product_model.dart';
// import 'package:jippymart_customer/models/vendor_model.dart';
...
//                                                                           Visibility(
//                                                                             visible:
//                                                                                 (vendorModel.isSelfDelivery == true && Constant.isSelfDeliveryFeature == true),
//                                                                             child:
//                                                                                 Row(
//                                                                               children: [
//                                                                                 Container(
