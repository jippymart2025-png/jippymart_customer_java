...
//
//   /// When true, header is not wrapped in Hero to avoid transition errors when opened from cart.
...
//
//   void _onScroll() {
//     if (_scrollController?.hasClients != true || !mounted) return;
//     // Guard: NestedScrollView can attach one controller to multiple scroll positions.
//     if (_scrollController!.positions.length != 1) return;
//     final scrollPosition = _scrollController!.offset;
//     final shouldShowTitle =
//         scrollPosition > _RestaurantScreenConstants.scrollThreshold;
//
//     if (shouldShowTitle != _showTitle && mounted) {
//       // Defer setState to next frame to avoid rebuild during scroll notification,
//       // which can cause "dependent is not a descendant" when route is tearing down.
//       WidgetsBinding.instance.addPostFrameCallback((_) {
//         if (!mounted) return;
//         setState(() {
...
//   void activate() {
//     super.activate();
//     // Re-attach scroll listener when route is resumed (e.g. after closing a dialog).
//     if (mounted) _setupScrollListener();
//   }
//
//   @override
//   void dispose() {
...
//   bool _showTitle = false;
//
//   // ── NEW: tracks whether to show the sticky search bar in the app bar ──
//   bool _showStickySearch = false;
//
//   // Height of the info card (header + status + coupons). Measured after first
//   // layout via a GlobalKey so the threshold is exact regardless of content.
//   double _headerCardHeight = 220.0; // sensible default until measured
//
...
//   }
//
//   /// Measures the rendered height of the header card so we use an accurate
//   /// threshold for showing the sticky search bar.
...
//         setState(() => _showStickySearch = shouldShowSearch);
//       }
//     });
//   }
//
...
//                 child: NestedScrollView(
//                   headerSliverBuilder: (context, innerBoxIsScrolled) => [
//                     _buildAppBar(controller, innerBoxIsScrolled),
//                   ],
//                   body: controller.isLoading
//                       ? resturantDetailsShimmer()
//                       : _buildBody(controller),
...
//       pinned: true,
//       automaticallyImplyLeading: false,
//       // ── Key change: same color as the header card below ──
//       backgroundColor: AppThemeData.primary300,
...
//                 // ── Sticky search bar fades in after scrolling past header ──
//                 ? _StickySearchBar(
//                     key: const ValueKey('search'),
//                     controller: controller,
//                   )
//                 // ── Restaurant title fades in after scrollThreshold ──
//                 : AnimatedBuilder(
...
//         crossAxisAlignment: CrossAxisAlignment.start,
//         children: [
//           // ── Info card: same AppThemeData.primary300 background as the AppBar
//           //    so the two sections read as one continuous surface. Rounded
//           //    bottom corners + soft shadow separate it from content below. ──
//           Container(
//             key: _headerCardKey,
...
//                   _CouponsSection(controller: controller),
//                 ],
//                 // ── Inline search bar lives here; disappears into AppBar
//                 //    once the user scrolls this card out of view ──
//                 const SizedBox(height: 16),
//                 _InlineSearchBar(controller: controller),
//                 const SizedBox(height: 4),
//               ],
//             ),
//           ),
...
// }
//
// // ==================== INLINE SEARCH BAR (inside header card) ====================
// class _InlineSearchBar extends StatelessWidget {
//   final RestaurantDetailsProvider controller;
//
//   const _InlineSearchBar({required this.controller});
//
//   @override
//   Widget build(BuildContext context) {
//     return Container(
...
// }
//
// // ==================== STICKY SEARCH BAR (inside AppBar) ====================
// class _StickySearchBar extends StatelessWidget {
//   final RestaurantDetailsProvider controller;
//
//   const _StickySearchBar({super.key, required this.controller});
//
//   @override
//   Widget build(BuildContext context) {
//     return Container(
...
//                     fontFamily: AppThemeData.semiBold,
//                     fontWeight: FontWeight.w600,
//                     // ── White text on the coloured card ──
//                     color: Colors.black,
//                   ),
//                 ),
//                 const SizedBox(height: 4),
...
//
// // ==================== MENU SECTION ====================
// // Note: search bar is now in the header card, so _MenuSection only
// // contains the category label and filter chips.
// class _MenuSection extends StatelessWidget {
//   final RestaurantDetailsProvider controller;
//
//   const _MenuSection({required this.controller});
