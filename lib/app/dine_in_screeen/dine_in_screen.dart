import 'package:jippymart_customer/app/dine_in_screeen/dine_in_details_screen.dart';
import 'package:jippymart_customer/app/dine_in_screeen/dine_in_restaurant_list_screen.dart';
import 'package:jippymart_customer/app/dine_in_screeen/view_all_category_dine_in_screen.dart';
...
import 'package:jippymart_customer/controllers/dine_in_controller.dart';
                      ...
                      ? Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                Constant.isZoneAvailable == false
                                    ? "We don't currently deliver to your location. Please try a different address within our service area.".tr
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                InkWell(
                                                  onTap: () {
                                                    Get.to(const DineInRestaurantListScreen(),
                                                        arguments: {"vendorList": controller.newArrivalRestaurantList, "title": "New Arrival"});
                                                  },
                                                  child: Text(
                                                    "View all".tr,
                                                    textAlign: TextAlign.center,
