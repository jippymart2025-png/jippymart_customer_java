import 'package:jippymart_customer/app/gift_card/screens/gift_card_screen/provider/gift_card_provider.dart';
import 'package:jippymart_customer/app/gift_card/screens/history_gift_card_screen/history_gift_card.dart';
import 'package:jippymart_customer/app/gift_card/screens/redeem_gift_card_screen/redeem_gift_card_screen.dart';
import 'package:jippymart_customer/app/gift_card/screens/select_gift_payment_screen/select_gift_payment_screen.dart';
import 'package:jippymart_customer/constant/constant.dart';
import 'package:jippymart_customer/constant/show_toast_dialog.dart';
import 'package:jippymart_customer/app/gift_card/screens/gift_card_screen/model/gift_cards_model.dart';
...
class GiftCardScreen extends StatelessWidget {
                              ...
                              return InkWell(
                                onTap: () {
                                  controller.selectedGiftCard.value =
                                      giftCardModel;
                                  controller.messageController.value.text =
                                      controller.selectedGiftCard.value.message
                                          .toString();
                                },
                                child: Padding(
  ...
  giftCardBottomSheet(BuildContext context, GiftCardProvider controller) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ClipRRect(
                          borderRadius: BorderRadius.circular(10),
                          child: NetworkImageWidget(
                            imageUrl: controller.selectedGiftCard.value.image
                                .toString(),
