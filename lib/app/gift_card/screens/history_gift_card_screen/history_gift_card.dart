import 'package:jippymart_customer/app/gift_card/screens/history_gift_card_screen/provider/history_gift_card_provider.dart';
...
class HistoryGiftCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<HistoryGiftCardProvider>(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          Constant.amountShow(
                                            amount: giftCardOrderModel.price
                                                .toString(),
                                          ),
                                          style: TextStyle(
                                            fontSize: 16,
