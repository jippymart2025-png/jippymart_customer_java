...
//             return Center(child: Constant.loader(message: 'Loading...'.tr));
//           }
//           final list = wp.coinLedger;
//           if (list.isEmpty) {
//             return Center(
//               child: Text(
//                 'No coin history yet.'.tr,
//                 style: TextStyle(
...
//                 return _LedgerTile(entry: list[i]);
//               },
//             ),
//           );
//         },
...
//             fontFamily: AppThemeData.semiBold,
//             fontSize: 16,
//             color: isCredit ? AppThemeData.success500 : AppThemeData.grey700,
//           ),
//         ),
//       ),
//     );
...
//     if (type == null) return 'Adjustment'.tr;
//     switch (type.toUpperCase()) {
//       case 'REFERRAL':
//         return 'Referral reward'.tr;
//       case 'ORDER_CREDIT':
//         return 'Order credit'.tr;
//       case 'CHECKIN':
//         return 'Daily check-in'.tr;
//       case 'STREAK_BONUS':
//         return 'Streak bonus'.tr;
//       case 'REDEEM_DEBIT':
//         return 'Redeemed'.tr;
//       case 'ADJUSTMENT':
...
//               .where((e) => (e.coins ?? 0) > 0)
//               .fold<int>(0, (sum, e) => sum + (e.coins ?? 0));
...
//       case 'STREAK_BONUS':
//         return {
//           'label': 'Streak Bonus'.tr,
//           'icon': Icons.local_fire_department_rounded,
//           'color': const Color(0xFFEA4C1E),
//           'bgColor': const Color(0xFFFFF4F0),
//         };
//       case 'REDEEM_DEBIT':
//         return {
//           'label': 'Redeemed'.tr,
