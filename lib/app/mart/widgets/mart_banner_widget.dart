...
class MartBannerWidget extends StatelessWidget {
    ...
    return Consumer<MartProvider>(
      builder: (context,controller,_) {
        return StreamBuilder<List<MartBannerModel>>(
          stream:controller.streamBannersByPosition(position, limit: limit),
    ...
    return Consumer<MartProvider>(
        ...
        return Container(
          ...
          child: GestureDetector(
            onTap: () => _handleBannerTap(banner,controller),
            child: ClipRRect(
  ...
  void _handleBannerTap(MartBannerModel banner,MartProvider controller) {
